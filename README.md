...
The current version supports Python 3.6, CUDA>=10.2 and PyTorch>=1.7, but it works fine with lower versions of CUDA and PyTorch. Please modify the `Dockerfile` as you want. If you do not use docker, please manually install the dependencies listed in the `Dockerfile`.
